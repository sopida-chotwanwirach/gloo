...
// StartRenewal(ctx context.Context, client *vault.Client, secret *vault.Secret) error
// StartRenewal(ctx context.Context, client *vault.Client, secret *vault.Secret) error
func (t *VaultRenewToken) StartRenewal(ctx context.Context, client *vault.Client, secret *vault.Secret) error {
...
func (r *RemoteTokenAuth) StartRenewal(ctx context.Context, client *vault.Client, secret *vault.Secret) error {
	go r.tokenRenewer.StartRenewal(ctx, client, secret)
	return nil
}
...
func (r *VaultRenewToken) renewToken(ctx context.Context, client *vault.Client, secret *vault.Secret) {
...
func (r *VaultRenewToken) manageTokenLifecycle(ctx context.Context, client *vault.Client, secret *vault.Secret, watcherIncrement int) (bool, error) {
